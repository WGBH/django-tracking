...
class SimpleTrackerTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        # Test cases
        cls.a01 = GatedTracker.objects.create(
            pk = 1,
        ...
        cls.a05 = GatedTracker.objects.create(
            pk = 5,
        ...
        cls.a06 = GatedTracker.objects.create(
            pk = 6,
        ...
        cls.a07 = GatedTracker.objects.create(
            pk = 7,
